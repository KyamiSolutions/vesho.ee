...
<div class="crm-page-header">
    ...
    <div class="crm-page-header__actions">
        ...
        <a href="<?php echo admin_url('admin.php?page=vesho-crm-docs'); ?>" class="crm-btn crm-btn-sm" style="background:rgba(255,255,255,.1);color:#fff;border:1px solid rgba(255,255,255,.25)">📖 Kasutusjuhend</a>
    </div>
</div>
