...
<div class="modal" id="login-modal" role="dialog" aria-modal="true" aria-labelledby="login-modal-title" aria-hidden="true" tabindex="-1">
    <div class="modal__inner" style="max-width:420px">
        ...
        <div class="lm-panel" id="lm-panel-login" style="padding:20px 0 4px">
            ...
            <?php if (class_exists('Vesho_Google_Auth') && Vesho_Google_Auth::enabled_for('client')): ?>
            <div style="display:flex;align-items:center;gap:12px;margin:16px 0 12px;color:#94a3b8;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:.5px">
                <span style="flex:1;border-top:1px solid #dce8ef"></span>või<span style="flex:1;border-top:1px solid #dce8ef"></span>
            </div>
            <a href="<?php echo esc_url(Vesho_Google_Auth::auth_url('client')); ?>"
