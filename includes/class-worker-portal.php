  ...
  <div>
    ...
    <div class="vwauth-card">
      ...
      <a href="<?php echo esc_url(Vesho_Google_Auth::auth_url('worker')); ?>"
         style="display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:12px;border:1.5px solid rgba(255,255,255,.25);border-radius:10px;background:rgba(255,255,255,.08);color:#ffffff;font-family:'Barlow',sans-serif;font-size:14px;font-weight:600;text-decoration:none;box-sizing:border-box;transition:.15s"
         onmouseover="this.style.borderColor='#00b4c8';this.style.background='rgba(0,180,200,.12)'"
         onmouseout="this.style.borderColor='rgba(255,255,255,.25)';this.style.background='rgba(255,255,255,.08)'">
        ...
        <span style="color:#ffffff!important">Jätka Google'iga</span>
      </a>
      <?php endif; ?>
