  ...
  <div>
    ...
    <div class="vwauth-card">
      ...
      <div style="display:flex;align-items:center;gap:12px;margin:16px 0;color:#94a3b8;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:.5px">
        <span style="flex:1;border-top:1px solid #e2e8f0"></span>või<span style="flex:1;border-top:1px solid #e2e8f0"></span>
      </div>
      <a href="<?php echo esc_url(Vesho_Google_Auth::auth_url('worker')); ?>"
         style="display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:12px;border:1.5px solid #e2e8f0;border-radius:8px;background:#ffffff;color:#1e293b;font-family:'Barlow',sans-serif;font-size:14px;font-weight:600;text-decoration:none;box-sizing:border-box;transition:.15s"
         onmouseover="this.style.borderColor='#00b4c8';this.style.background='#f0fbfc'"
        ...
        <span style="color:#1e293b!important">Jätka Google'iga</span>
      </a>
      <?php endif; ?>
  ...
  window.startQRLogin = function(){
    ...
    private static function render_dashboard($worker) {
        ...
        $wico = [
            ...
            'download' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>',
            'list'     => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>',
        ];
        $nav_items = [
            'overview'   => ['icon' => $wico['home'],     'label' => 'Ülevaade'],
            'active'     => ['icon' => $wico['zap'],      'label' => 'Aktiivsed',  'badge' => $active_count ?: null],
            'history'    => ['icon' => $wico['clock'],    'label' => 'Ajalugu'],
            'schedule'   => ['icon' => $wico['calendar'], 'label' => 'Graafik'],
            'tellimused' => ['icon' => $wico['cart'],     'label' => 'Tellimused', 'badge' => $shop_count ?: null],
        ];
...
/* Globaalsed alused */
html:has(.vwp-wrap){overscroll-behavior-x:none}body:has(.vwp-wrap){overscroll-behavior-x:none;touch-action:pan-y;overflow-x:hidden}
