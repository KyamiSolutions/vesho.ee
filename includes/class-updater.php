...
/**
 * Self-hosted update system for Vesho CRM plugin and Vesho theme.
 *
 * How it works:
 * 1. This class hooks into WordPress update transients
 * 2. It checks a JSON file on the server for new versions
 * 3. When a newer version is found, WordPress shows "Update available"
 * 4. Admin clicks Update → WP downloads the ZIP → installs it
 *
 * The JSON files and ZIPs are stored in wp-content/uploads/vesho-releases/
 * and are generated by the Release Manager admin page.
 */
class Vesho_CRM_Updater {
    ...
    public static function get_server_url() {
        ...
        // Default: same site's uploads directory
        $upload = wp_upload_dir();
        return rtrim( $upload['baseurl'], '/' ) . '/vesho-releases';
    }
